...
App.button_Stop.grid(row=0, column=1, padx=5)

App.button_SSFarm = ctk.CTkButton(App.button_frame, text="Start SSFarm", command=bttn_start_SSFarm)
App.button_SSFarm.grid(row=0, column=2, padx=5)

App.button_Farm = ctk.CTkButton(App.button_frame, text="Start Farm", command=bttn_start_Farm)
App.button_Farm.grid(row=0, column=3, padx=5)
